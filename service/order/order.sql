CREATE TABLE `order`(
    ...
    `pay_channel` tinyint(4) UNSIGNED NOT NULL DEFAULT '' COMMENT '支付方式',
    `status` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '订单状态:100 创建订单/待支付 200 已支付 300 交易失败',
    ...
    INDEX (trade_id),
    INDEX (is_del)
)ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COMMENT= '订单号';